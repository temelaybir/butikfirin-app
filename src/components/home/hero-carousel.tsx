...
export function HeroCarousel({ slides }: HeroCarouselProps) {
  ...
  return (
    <div
      className="relative w-full h-[280px] sm:h-[320px] md:h-[360px] lg:h-[400px] xl:h-[480px] 2xl:h-[520px] overflow-hidden rounded-xl group shadow-lg bg-gray-100 flex items-center justify-center"
