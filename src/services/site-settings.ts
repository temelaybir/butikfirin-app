...
const defaultSettings: Partial<SiteSettings> = {
  ...
  site_description: 'Butik Fırın - Taze ve lezzetli ürünler',
  site_slogan: 'Her gün taze, her lokma lezzet',
  site_logo_url: '/logo.svg',
  favicon_url: '/favicon.ico',
  social_image_url: '/social-preview.jpg',
  meta_keywords: 'butik fırın, pasta, börek, poğaça, taze ürünler, beylikdüzü fırın',
...
export async function getThemeSettings(): Promise<ThemeSettings> {
  try {
    ...
    return data[0] as ThemeSettings
  } catch (error) {
